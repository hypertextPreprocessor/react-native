	...
	_renderHeader(item, expanded){
		return (
			<View style={{width:'100%',flexDirection: "row",paddingVertical:10,justifyContent: "space-between",alignItems: "center" , backgroundColor: "#A9DAD6"}}>
				<Text>{"设备:"+item.device+"/型号"+item.type}</Text>
				 {expanded
					...
					<Col size={5} style={{backgroundColor:"#FFF"}}>
						...
						<Body style={styles.CardBody}>
							<View style={{width:'100%'}}>
								...
								<View style={{flex:1,alignSelf:'flex-end'}}><Text>文件编号：#3215151513</Text></View>
							</View>
							...
							<View style={{width:'100%',flex:1,flexDirection:'row',alignItems:'center'}}>
								<View style={{flex:1,alignItems:'center'}}>
									<Text style={styles.tabCon}>请仔细查阅（实验要求）并严格按照以上要求进行操作</Text>
							...
							<CardItem>
								<Body style={styles.CardBody}>
									<View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
										<View style={{flex:0.16}}><Text style={styles.tabTitle}>测试项目</Text></View>
										<View style={{flex:0.16}}><Text style={styles.tabTitle}>仪器、仪表</Text></View>
										<View style={{flex:0.16}}><Text style={styles.tabTitle}>测试部位</Text></View>
										<View style={{flex:0.16}}><Text style={styles.tabTitle}>测试编号</Text></View>
										<View style={{flex:0.16}}><Text style={styles.tabTitle}>记录人员</Text></View>
										<View style={{flex:0.16}}><Text style={styles.tabTitle}>备注</Text></View>
									</View>
									<View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
										<View style={{flex:0.16}}><Text style={styles.tabCon}>入炉冷空气温度</Text></View>
										<View style={{flex:0.16}}><Text style={styles.tabCon}>温、湿度表</Text></View>
										<View style={{flex:0.16}}><Text style={styles.tabCon}>鼓风机进风口</Text></View>
										<View style={{flex:0.16}}><Text style={styles.tabCon}>00001</Text></View>
										<View style={{flex:0.16}}><Text style={styles.tabCon}>马松</Text></View>
										<View style={{flex:0.16}}><Text style={styles.tabCon}>无</Text></View>
									</View>
									<View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
										<View style={{flex:0.16}}><Text style={styles.tabCon}>排烟温度</Text></View>
										<View style={{flex:0.16}}><Text style={styles.tabCon}>温度测量仪</Text></View>
										<View style={{flex:0.16}}><Text style={styles.tabCon}>出口烟道一米范围内</Text></View>
										<View style={{flex:0.16}}><Text style={styles.tabCon}>00002</Text></View>
										<View style={{flex:0.16}}><Text style={styles.tabCon}>赵工</Text></View>
										<View style={{flex:0.16}}><Text style={styles.tabCon}>无</Text></View>
									</View>
									<View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
										<View style={{flex:1,alignItems:'center'}}>
									...
									<View style={{flex:1,flexDirection:'row',alignItems:'center',paddingVertical:20}}>
										<View style={{flex:0.33}}>
											<Item inlineLabel style={{width:'50%'}}>
												<Input placeholder='a1取值' />
											</Item>
										</View>
										<View style={{flex:0.33}}>
											<Item inlineLabel style={{width:'50%'}}>
												<Input placeholder='a2取值' />
											</Item>
										</View>
										<View style={{flex:0.33}}>
											<Item inlineLabel style={{width:'50%'}}>
												<Input placeholder='a3取值' />
											</Item>
										</View>
									</View>
									<View style={{flex:1,flexDirection:'row',alignItems:'center',alignContent:'center'}}>
										<View style={{flex:0.5,flexDirection:'row',alignItems:'center'}}>
											...
											<Button style={{marginHorizontal:12}} light onPress={()=>{this.signName(0)}}>
												{
													!this.state.signature0?(<Text> 点击签名 </Text>):(
													<Image style={{width:80,height:30,resizeMode:'contain'}} source={{uri:this.state.signature0}} />
												)}
											</Button>
										</View>
										<View style={{flex:0.5,flexDirection:'row',alignItems:'center'}}>
									...
									<View style={{flex:1,flexDirection:'row',alignItems:'center',alignContent:'center'}}>
										<View style={{flex:0.5,flexDirection:'row',alignItems:'center'}}>
											...
											<Button style={{marginHorizontal:12}} light onPress={()=>{this.signName(1)}}>
												{
													!this.state.signature1?(<Text> 点击签名 </Text>):(
													<Image style={{width:80,height:30,resizeMode:'contain'}} source={{uri:this.state.signature1}} />
												)}
											</Button>
										</View>
										<View style={{flex:0.5,flexDirection:'row',alignItems:'center'}}>
								...
								<Body style={styles.CardBody}>
									...
									<View style={styles.table}>
										...
										<View style={{display:'flex',flex:0.4,flexDirection:'row',flexWrap:'nowrap',alignContent:'center',alignItems:'center'}}>
											...
											<Button style={{marginHorizontal:12}} light onPress={()=>{this.signName(2)}}>
												{
													!this.state.signature2?(<Text> 点击签名 </Text>):(
													<Image style={{width:80,height:30,resizeMode:'contain'}} source={{uri:this.state.signature2}} />
												)}
											</Button>
										</View>
